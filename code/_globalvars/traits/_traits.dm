...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_SEE_BLESSED_TILES" = TRAIT_SEE_BLESSED_TILES, // XANTODO implement the blessed tiles trait
	...
	/obj/item = list(
		...
		"TRAIT_MECHCOMP_INTERACTION_BANNED" = TRAIT_MECHCOMP_INTERACTION_BANNED,
		"TRAIT_ROD_MANSUS_INFUSED" = TRAIT_ROD_MANSUS_INFUSED, // This should go on /obj/item/fishing_rod if anyone ports more of the fishing stuff
