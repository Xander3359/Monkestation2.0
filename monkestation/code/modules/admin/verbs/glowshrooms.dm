ADMIN_VERB(delete_all_glowshrooms, R_ADMIN, "Delete All Glowshrooms", "Deletes all glowshrooms in the world. Use this instead of SDQL, as this prevents them from spreading mid-deletion.", ADMIN_CATEGORY_GAME)
...
ADMIN_VERB(toggle_glowshroom_spread, R_ADMIN, "Toggle Glowshroom Spreading", "Toggles whether glowshrooms can spread or not. You don't need to use this if you're using the Delete All Glowshrooms verb, as that handles that on its own.", ADMIN_CATEGORY_GAME)
